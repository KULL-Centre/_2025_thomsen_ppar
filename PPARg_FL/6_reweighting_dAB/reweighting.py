...
#BME reweighting
thetas = np.geomspace(1,10000,20)
    
exp_file = f'PPARg_dAB_SAXSexpt.dat'
calc_file = f'calc_SAXS_{traj}.dat'
...
for theta in thetas: 
    ...
    rew = BME.Reweight(f'BME_{traj}_theta{theta}')
...
save_pickle(f'reweighting_{traj}.pkl', reweighting)
